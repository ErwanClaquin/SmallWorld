...
case7 = Case([2, 3, 6, 8, 11, 12], True, caseShovel, False, None, None, 162, 180)
...
case11 = Case([6, 7, 12, 17, 18], True, caseNormal, False, None, None, 288, 237)
...
case16 = Case([17], True, caseNormal, False, None, None, 80, 235)
...
case32 = Case([30, 31, 33, 35], False, caseMagic, True, None, None, 475, 922)
...
case41 = Case([38, 40, 42], True, caseCave, False, None, None, 924, 600)
